import 'package:dio/dio.dart';
 ...
 Future<Map> getDistanceMatrix(double sourceLat, double sourceLong, double destLat, double destLong)
 async {
   Dio dio = new Dio();
   ...
   var result = {'destination': response.data['destination_addresses'], 'distance': double.parse(splitDistance[0])};
